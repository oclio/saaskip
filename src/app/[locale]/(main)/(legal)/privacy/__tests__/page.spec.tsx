...
describe('PrivacyPage', () => {
  ...
  describe('generateMetadata', () => {
    it('delegates to createPageMetadata with the privacy namespace', async () => {
  ...
  describe('rendering', () => {
    ...
    it('uses the pages.privacy translation namespace', async () => {
      await PrivacyPage();

      expect(getTranslations).toHaveBeenCalledWith('pages.privacy');
    });
  });
});
